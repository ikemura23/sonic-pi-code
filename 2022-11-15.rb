...
live_loop :base, sync: :met do
  ...
  with_fx :reverb, room: 0.5, mix: 0.5 do
    with_fx :lpf, cutoff: 90 do
      ...
      8.times do
        #4006 607, 4007 608, 4008 609, 3000 400, 3100 410
        use_random_seed 4000 #4006
        sc = (scale :e1, :rast, num_octaves: 2).ring
        4.times do
          s = sc.choose
          synth :dsaw, note: s, sustain: 0.05, release: 0.2, amp: 1
          ##| synth :saw, note: s+24, sustain: 0.05, release: 0.2, amp: 0.5
...
live_loop :mero2, sync: :met do
  ...
  ##| sleep 3
  play chord(:e4, :sus4, invert: [0,1,-2,1].choose), sustain: 10, release: 2, attack: 0, amp: 4
  sleep 10
end
##| end
