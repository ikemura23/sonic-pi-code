...
live_loop :clap1, sync: :met do
  ...
  with_fx :reverb, mix: 0.4 do
    ...
    ##| synth :sc808_clap, amp: 1, rate: 0.8
  end
  sleep 0.5
end
...
live_loop :synth1, sync: :met do
  ...
  with_fx :reverb, mix: 0.7, room: 0.4 do
...
live_loop :synth2, sync: :met do
  ...
  use_synth :dpulse # :supersaw :dsaw :dpulse
  use_synth_defaults release: 0.25, cutoff: 100, amp: 1
...
live_loop :pico, sync: :met do
  ...
  use_synth :pulse
  use_synth_defaults release: 0.2, amp: 0.2, cutoff: 90
...
live_loop :bass_loop, sync: :met do
  ...
  use_synth :dsaw
  use_synth_defaults release: 0.1, cutoff: 45, amp: 1.5, attack: 0.05
