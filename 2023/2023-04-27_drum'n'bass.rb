...
live_loop :drum_loop, sync: :met do
  if sample_loop_play < 1 then stop end
  
  sample top_loops, 5, amp: 0.5, beat_stretch: 8, hpf: 118/3
  sleep 8
end
...
with_fx :reverb, room: 0.2, mix: 0.5 do
  ...
  live_loop :ride_cymbal, sync: :met do
    ...
    use_sample_defaults beat_stretch: 1.8, amp: 0.20
    
    if ride_cymbal_type < 1 then
      sample :drum_cymbal_hard, amp: 0.20/3
      sleep 0.25
      ...
      sample :drum_cymbal_hard
      sleep 0.25
      sample :drum_cymbal_hard, amp: 0.135
      sleep 0.125
      sample :drum_cymbal_hard, amp: 0.135
      sleep 0.125
    end
...
live_loop :synth2, sync: :met do
  ...
  with_fx :bpf, centre: 80, mix: 0.9 do
    with_fx :wobble, invert_wave: 1, phase: 16, wave: 0, mix: 0.2 do
      ...
      with_fx :slicer, phase: 0.375, mix: 0.1 do
        synth :dsaw, note: chord(:fs3, :M7)
        sleep 8
