...
live_loop :misc_cineboom, sync: :met do
  ...
  sleep 14
  play :b2 , sustain: 1.7, release: 0.3, note_slide: 2, amp: 1.8 do |s|
    control s, note: :b1
  end
  sleep 2
end
...
live_loop :synth1, sync: :met do
  ...
  use_synth_defaults release: 0, sustain: 2, amp: 0.9, attack: 0.12
  ...
  with_fx :bpf, centre: 80, mix: 0.9 do
    ...
    synth :dsaw, note: chord(key+3, :M7, invert: 0)
    sleep 2
