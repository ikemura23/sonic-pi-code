...
define :bass1 do | note, ef=0|
  with_fx :reverb do
    ...
    default_cutoff = 70
    default_amp = 1.3
    use_synth_defaults release: 0.1, sustain: 0.125,release: 0.12, amp: default_amp, attack_level: 0, attack: 0, cutoff: default_cutoff
    
    use_random_seed 318 # 318 346 322
    key = :ds1
...
live_loop :synth2, sync: :met do
  ...
  with_fx :reverb, mix: 0.7, room: 0.7 do
    ...
    sleep 2.25
    synth :dsaw, note: chord(:fs4, :sus4, invert: 0) ,release: 0.125, attack: 0, cutoff: 80
    sleep 1.75
  end
