# output https://twitter.com/ikemura23/status/1602906233299644417
use_debug false
use_bpm 60
...
live_loop :mero, sync: :met do
  ...
  with_fx :reverb, mix: 0.5, room: 0.5 do
    ...
    cds1.size.times do |i|
      ...
      c2 = cds2[i]
      sl.size.times do
        synth :rodeo, note: c, release: 0.4, amp: 1
        synth :sine, note: c2+12, sustain: 0.25, release: 0, amp: 0.8
        sleep sl.tick
      end
    end
    ##| end
